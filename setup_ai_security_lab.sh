...
"
    ...
    # Garak generator config — openai.OpenAICompatible needs uri set via config,
    # not env. Reference with --generator_option_file /opt/ai-security-lab/garak-target.yaml
